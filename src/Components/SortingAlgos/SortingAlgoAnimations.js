import { bubble_sort, insertion_sort, quicksort, merge_sort } from "./SortingAlgos.js"


export function execute_quicksort_animations(arr, speed, resetRef, sortRef, benchRef, callbenches) {
  var animations = [];
  var bench_arr = [...arr]
  quicksort(arr, 0, arr.length - 1, animations);
  resetRef.current.setAttribute("disabled", "disabled")
  sortRef.current.setAttribute("disabled", "disabled")
  benchRef.current.setAttribute("disabled", "disabled");
  ...
  var interval = setInterval(() => {
      ...
      if (i === animations.length - 1) {
          ...
          benchRef.current.removeAttribute("disabled")
...
export function execute_mergesort_animations(arr, speed, resetRef, sortRef, benchRef, callbenches) {
...
export function execute_simplesort_animations(arr, speed, resetRef, sortRef, benchRef, type, callbenches) {
